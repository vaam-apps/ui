...
export const STORY = {
  ...
  datePickerInDrawer: "primitives-date-pickers--inside-a-drawer",
  datePickerSingleDocked: "primitives-date-pickers--single-docked",
  datePickerSinglePhone: "primitives-date-pickers--single-on-a-phone",
  datePickerDropdownPhone: "primitives-date-pickers--dropdown-on-a-phone",
  datePickerModalDesktop: "primitives-date-pickers--modal-on-a-desktop",
  datePickerRange: "primitives-date-pickers--range",
  datePickerRangePhone: "primitives-date-pickers--range-on-a-phone",
  datePickerBounded: "primitives-date-pickers--bounded",
  datePickerRelabelled: "primitives-date-pickers--relabelled",
  calendarRange: "primitives-date-pickers--calendar-range",
